    <h2 class="text-center py-3 catalog-category-title"><?php $_SESSION['nombreSubcategoria'];?></h2>
        ...
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-footer">
                ...
                <p class="p-1 align-items-center d-flex">
                    ...
                    <a class="ml-3" href="mailto:ventas@botesparabasura.com" style="font-size: 16px;">contacto@botesparabasura.com</a>
                </p>
